      ...
      <div class="filter__view-block">
        ...
        <div class="filter__row">
          <FilterBlock title="Цены:">
            <FilterPrice @select-prices="getPrices" />
          </FilterBlock>
          <FilterBlock title="Цвет:" v-if="colors && colors.success">
            <FilterColor :colors="colors.colors" @select-color="getColor" />
          </FilterBlock>
        </div>
        <button class="filter__submit" @click="emit( 'filterClick' )">Применить</button>
        <div class="filter__reset">
          <NuxtLink to="/catalog">Сбросить фильтры</NuxtLink>
        </div>
      </div>
    </div>
  </div>
...
const emit = defineEmits(['selectPrices', 'selectColor', 'filterClick']);

const getPrices = ( prices: object ) => {
