<template>
  <div class="h-24 bg-white border-t border-gray-200 px-4 py-3 flex items-center gap-2">
    <!-- Input field -->
    <input
        v-model="messageText"
        type="text"
    ...
    <!--    <button-->
    <!--        disabled-->
    <!--        class="w-10 h-10 rounded-lg hover:bg-gray-100 text-gray-400 flex items-center justify-center disabled:cursor-not-allowed"-->
...
const handleSend = () => {
  if (!messageText.value.trim() || props.disabled || props.loading) return
