<template>
  <div class="flex gap-2 m-4 bg-opacity-0 justify-end">
    <!-- VK -->
    <a
        href="https://vk.com/im/convo/-221071922?entrypoint=vkcom_right_column_menu&tab=all"
        target="_blank"
        rel="noopener noreferrer"
        class="w-16 h-16 rounded-full bg-blue-600 hover:bg-blue-700 text-white flex items-center justify-center
    transition-colors"
    ...
    <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        class="w-16 h-16 rounded-full bg-blue-400 hover:bg-blue-500 text-white flex items-center justify-center transition-colors"
...
// Этот компонент для отображения соцсетей
// Может быть использован в ChatHeader в будущем
</script>